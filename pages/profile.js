            ...
            <div className="profile-grid">
                ...
                <div className="profile-card">
                    ...
                    <form onSubmit={handlePasswordSubmit}>
                        ...
                        <div className="form-group"><label>كلمة المرور الجديدة</label><input type="password" name="newPassword" onChange={handlePasswordChange} required /></div>
                        <div className="form-group"><label>تأ��يد كلمة المرور الجديدة</label><input type="password" name="confirmPassword" onChange={handlePasswordChange} required /></div>
