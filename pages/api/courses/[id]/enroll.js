...
export default async function handler(req, res) {
    ...
    try {
        ...
        const enrollment = await pool.query(`INSERT INTO enrollments (user_id, course_id, status) VALUES ($1, $2, 'pending_payment') RETURNING *`, [userId, courseId]);
        ...
        res.status(201).json({ message: 'تم التقديم بنجاح، بانتظار سداد الرسوم.' });
    } catch (err) {
